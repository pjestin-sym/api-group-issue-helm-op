...
# symphony.com/api-group-issue-helm-op-bundle:$VERSION and symphony.com/api-group-issue-helm-op-catalog:$VERSION.
IMAGE_TAG_BASE ?= symphony.com/api-group-issue-helm-op
